...
export type GetCompetitionVolunteersShiftsResponse = Schemas.VolunteerShift[];
...
export const usePostRaidTeamsGeneratePdf = (
  ...
  >({
    mutationFn: (variables: PostRaidTeamsGeneratePdfVariables) =>
      fetchPostRaidTeamsGeneratePdf({ ...fetcherOptions, ...variables }),
    ...options,
  });
};
...
export type PostRaidClearDocumentsError = Fetcher.ErrorWrapper<undefined>;

export type PostRaidClearDocumentsVariables = HyperionContext["fetcherOptions"];

/**
 * For each participant, for all their document, check if this document exists, if not, clear the document from the participant
 */
export const fetchPostRaidClearDocuments = (
  variables: PostRaidClearDocumentsVariables,
  signal?: AbortSignal,
) =>
  hyperionFetch<undefined, PostRaidClearDocumentsError, undefined, {}, {}, {}>({
    url: "/raid/clear_documents",
    method: "post",
    ...variables,
    signal,
  });
 ...
 * For each participant, for all their document, check if this document exists, if not, clear the document from the participant
 */
export const usePostRaidClearDocuments = (
  options?: Omit<
    reactQuery.UseMutationOptions<
      undefined,
      PostRaidClearDocumentsError,
      PostRaidClearDocumentsVariables
    >,
    "mutationFn"
  >,
) => {
  ...
  return reactQuery.useMutation<
    ...
    PostRaidClearDocumentsVariables
  >({
    mutationFn: (variables: PostRaidClearDocumentsVariables) =>
      fetchPostRaidClearDocuments({ ...fetcherOptions, ...variables }),
    ...options,
  });
};
