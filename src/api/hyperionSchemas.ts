...
export type BodyValidateVolunteerRegistrationCompetitionVolunteersShiftsShiftIdUsersUserIdValidationPatch =
  {
    validated: boolean;
  };
...
export type BookingReturn = {
  ...
  entity?: string | null;
  id: string;
  decision: AppModulesCalendarTypesCalendarDecision;
  applicant_id: string;
  room: RoomComplete;
};
...
export type CompetitionEditionStats = {
  users_stats: CompetitionUsersStats;
  sports_stats: CompetitionSportsStats;
  revenues_stats: CompetitionRevenueStats[];
};
...
export type CompetitionSportsStats = {
...
export type CompetitionUsersStats = {
  total_users: number;
  total_athletes: number;
  total_cameramen: number;
  total_pompoms: number;
  total_fanfares: number;
...
export type VolunteerShiftCompleteWithVolunteers = {
  name: string;
  manager_id: string;
  description?: string | null;
  /**
  ...
  edition_id: string;
  manager: CoreUser;
  registrations?: VolunteerRegistrationWithUser[];
};
...
export type AppCorePaymentSchemasPaymentPaymentUrl = {
  url: string;
};
...
export type AppModulesAmapSchemasAmapCashEdit = {
  balance: number;
};
...
export type AppModulesCalendarTypesCalendarDecision =
  | "approved"
  | "declined"
  | "pending";
